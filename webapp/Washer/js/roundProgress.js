...
angular.module('angular-svg-round-progress').service('roundProgressService', [function(){
    ...
    service.updateState = function(val, total, R, ring, size, isSemicircle) {
        ...
        var value       = val >= total ? total - 0.00001 : val,
            type        = isSemicircle ? 270 : 359.9999,
            ...
            return angular.extend(base, {
                ...
                link: function (scope, element) {
                    ...
                    var renderCircle = function(){
                        ...
                        var diameter         = options.diameter;//radius*2;
                        var backgroundSize   = radius - (stroke/2);

                        element.css({
                            "width":        diameter + "px",
                            "height":       (isSemicircle ? diameter : diameter) + "px",
                        ...
                        if(isSemicircle){
                            ring.attr("transform", options.clockwise ? "translate("+ diameter/2 +","+ diameter*1.21 +") rotate(-135)" : "translate("+ diameter +", "+ diameter +") rotate(90) scale(-1, 1)");
                        }else{
